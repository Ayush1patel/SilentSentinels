...
- Sends real emergency notifications to configured contacts

**To Configure WhatsApp Alerts:**
1. Get a Twilio account (www.twilio.com)
2. Add Twilio credentials to `.env`:
   ```env
   TWILIO_ACCOUNT_SID=AC...
   TWILIO_AUTH_TOKEN=...
   TWILIO_WHATSAPP_FROM=whatsapp:+1...
   EMERGENCY_CONTACTS=+1...,+44...
   ```
3. Test with your configured emergency contacts
