...
- "FIRE_ALARM" or "SMOKE_ALARM" → EMERGENCY (fire detected)
- "EMERGENCY_SIREN" → EMERGENCY (general emergency)
- "DISTRESS" or "DISTRESS_PATTERN" → EMERGENCY (someone in distress)
- "SMOKE_ALARM_BEEP_PATTERN" → EMERGENCY (smoke alarm beeping)
...
- "reason" must be a SHORT, CLEAR, USER-FRIENDLY message (NOT technical)
- DO NOT mention isGunshot, top10, confidence percentages, or technical terms
- Good examples: "Gunshot detected nearby", "Smoke alarm sounding", "Glass breaking heard", "Someone screaming for help"
- Bad examples: "Gunshot detected based on isGunshot=true", "Emergency due to pattern analysis"
- "recommendation" must be a clear, actionable safety instruction

Output ONLY valid JSON:
{"emergency": boolean, "reason": "short clear message", "recommendation": "specific action for deaf user"}`;
